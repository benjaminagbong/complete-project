<?php
$today_donation_count = print_count('campaigns_payment',array('user_id'=>$user_details->id,'payment_status'=>1,'date(on_date)'=>date('Y-m-d')));
$today_donation_amount =0;
$string  = "select sum(amount) as t_amount from campaigns_payment where user_id= ".$user_details->id." and payment_status= 1 and date(on_date)='".date('Y-m-d')."'";
...
<div class="d-flex justify-content-between">
  ...
  <a href="<?=$_user_link.'/donations'?>" class="tx-gray-600 hover-info"><i class="icon ion-more tx-16 lh-0"></i></a>
