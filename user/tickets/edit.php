...
<?php echo validation_errors();?>
 <?=form_open(NULL, array('class' => 'form-horizontal edit-form', 'role'=>'form','enctype'=>"multipart/form-data"))?>
        ...
        <div class="row form-group">
          ...
          <div class="col-lg-10">
            <?=form_textarea('description', html_entity_decode(set_value('description', $tickets->{'description'})), 'placeholder="" id="information" rows="3" class="ci-editor form-control" required')?>
          </div>
        </div>
...
<?php /*?><link href="assets/plugins/uploader/css/uploadfile.css" rel="stylesheet">
