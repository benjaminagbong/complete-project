            ...
            <div class="col-auto">
                <div class="align-container">
                    <div class="align-container__item"><!--<span class="promo-primary__pre-title">Helpo</span>-->
                        <h1 class="promo-primary__title"><span>Forgot Password</span></h1>
                    </div>
                </div>
            </div>
        </div>
...
<div class="form__fieldset">
	<h6 class="form__title">Forgot Your Password</h6>
<div class="row">
    <div class="col-12">
        <input class="form__field" type="email" name="email" placeholder="Email Address" required/>
    </div>

<div class="col-12 text-center">
        <button class="form__submit submitBtn" type="submit">Submit</button>
    </div>
<div class="col-12 text-center"><strong><a class="form__link" href="<?=site_url().'secure/register'?>">Sign up</a> if you don't have an account</strong></div>
