...
<div class="form-group" >
	...
	<div class="col-md-10">
		<?=form_input('bank_name', set_value('bank_name', $form_data->{'bank_name'}), 'class="form-control" required')?>
	</div>
</div>
...
<div class="form-group" >
	...
	<div class="col-md-10">
		<?=form_input('account_name', set_value('account_name', $form_data->{'account_name'}), 'class="form-control" required')?>
	</div>
</div>
...
<div class="form-group" >
	...
	<div class="col-md-10">
        <input type="text" name="address" value="<?=set_value('address', $form_data->{'address'})?>" class="form-control " required/>
	</div>
</div>
...
<div class="form-group" >
	...
	<div class="col-md-10">
        <input type="text" name="ifsc" value="<?=set_value('ifsc', $form_data->{'ifsc'})?>" class="form-control " required/>
	</div>
</div>
...
<div class="form-group" >
	...
	<div class="col-lg-10">
<?=form_checkbox('enabled', '1', set_value('enabled', $form_data->enabled), '')?>
	</div>
</div>    
