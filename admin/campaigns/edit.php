...
<div class="form-group row" >
    <label class="col-md-3 control-label">Fund Required</label>
    <div class="col-md-9">
    	<input type="number" name="campaign_funds" value="<?=set_value('campaign_funds', $form_data->{'campaign_funds'})?>" class="form-control "required>
    </div>
</div>	
...
<div class="form-group row" >
    ...
    <div class="row">
	    <div class="col-md-6">
			<?=form_input('b_f_name', set_value('b_f_name', $form_data->{'b_f_name'}), 'class="form-control " required')?>
	    </div>
	    <div class="col-md-6">
		<?=form_input('b_l_name', set_value('b_l_name', $form_data->{'b_l_name'}), 'class="form-control " required')?>
	    </div>
	</div>        
	</div>        
</div>
...
<div class="form-group row" >
    ...
    <div class="col-md-9">
		<textarea name="description" class="form-control ci-editor" required="required"><?=$form_data->description?></textarea>
    </div>
</div>	
